        ...
        <div className={style.rd_Header}>
          <div className={style.rd_Topic}>
            ...
            <div className={style.rd_Author}>
              ...
              {/* ปุ่ม + dropdown สำหรับ mobile */}
              <div className={style.rd_InfoDropdown}>
                <button
                ...
                >
                  ...
                  >
                    <path d="M544 224L320 448 96 224" />
                  </svg>
                </button>
                {showInfo && (
                  <div className={style.rd_InfoDropdownMenu}>
              ...
              {/* ของเดิมสำหรับ desktop ซ่อนตอน mobile */}
              <div className={style.rd_PrepTime}>
