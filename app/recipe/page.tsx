...
function RecipeDetailPage() {
  ...
  return (
    <main className={style.recipeDetailContainer}>
      <section className={style.recipeDetail_SectionOne}>
        <div className={style.recipeDetailHeader}>
        ...
        <div className={style.recipeDetail_Body}>
          <div className={style.recipeDetailBody_Header}>
            <Image
          ...
          <p className={style.recipeDetail_BodyDetail}>
      ...
      <section className={style.recipeDetail_SectionTwo}>
        <div className={style.recipeDetail_Ingredients}>
          <h1>Ingredients</h1>
          <div className={style.recipeDetail_ForMainDish}>
            <h1>For main dish</h1>
            <div className={style.recipeDetail_ForMainDishDetail}>
              <CircleCheckBox
          ...
          <div className={style.recipeDetail_ForTheSauce}>
            <h1>For the sauce</h1>
            <div className={style.recipeDetail_ForTheSauceDetail}>
              <CircleCheckBox
                label="Lorem ipsum dolor sit amet."
                id="sauceOne"
        ...
        <div className={style.recipeDetail_OtherRecipe}>
          <h1>Other Recipe</h1>
        </div>
      </section>
    </main>
